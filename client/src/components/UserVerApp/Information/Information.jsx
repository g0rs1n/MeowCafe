                ...
                <div className='wrapper-information-page'>
                    <div className='information-page'>
                        ...
                        <div className="information-main">
                            <div className="information-main-status">
                                <h3 className="information-main-status__h3">
                                    We are:
                                </h3>
                                <span className="information-main-status__span">
                                    {information.status}
                                </span>
                            </div>
                            <div className="information-main-times">
                            ...
                            <div className="information-main-days">
